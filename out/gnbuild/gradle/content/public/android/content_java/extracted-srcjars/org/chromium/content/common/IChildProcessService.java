...
abstract class Stub extends android.os.Binder implements org.chromium.content.common.IChildProcessService
{
...
int setupConnection(android.os.Bundle args, org.chromium.content.common.IChildProcessCallback callback) throws android.os.RemoteException;
// Asks the child service to crash so that we can test the termination logic.

void crashIntentionallyForTesting() throws android.os.RemoteException;
}
